-- Force backfill for order 10004
-- We assume the column order_number exists (added in another migration)
DO $$
DECLARE
    v_student_id UUID;
    v_instructor_id UUID;
    v_price_cents BIGINT;
    v_target_date TIMESTAMPTZ := '2026-01-26 12:00:00+00'; -- 9:00 Brasilia
BEGIN
    -- Get order details
    ...
    IF v_student_id IS NOT NULL THEN
        ...
        END IF;
    ELSE
        RAISE WARNING 'Order 10004 not found during backfill attempt';
    END IF;
END $$;
