        ...
        <div className="bg-[#f6f7f8] dark:bg-[#111921] text-[#0e141b] dark:text-gray-100 font-sans transition-colors duration-200 overflow-hidden h-screen w-screen relative">
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div className="modal-content relative w-full max-w-[480px] bg-white dark:bg-[#1a232e] rounded-2xl shadow-2xl overflow-hidden flex flex-col h-auto min-h-[580px] border border-gray-100 dark:border-gray-800">
                    ...
                    {/* Step 1 */}
                    <div className={`w-full h-full p-8 md:p-10 bg-white dark:bg-[#1a232e] flex flex-col justify-center items-center transition-all duration-500 absolute inset-0 ${step === 1 ? 'translate-x-0 opacity-100 pointer-events-auto' : '-translate-x-full opacity-0 pointer-events-none'}`}>
                        <div className="text-center mb-8 mt-2 w-full max-w-sm">
                            ...
                            <label className="block">
                                ...
                                <div className="relative group">
                                    <div className="flex items-center w-full rounded-xl border border-[#d1dbe6] dark:border-gray-600 bg-[#f6f7f8] dark:bg-[#111921] focus-within:ring-2 focus-within:ring-[#207fdf] focus-within:border-[#207fdf] transition-all overflow-hidden h-14">
                                        ...
                                        <input autoComplete="tel" className="w-full h-full bg-transparent border-none text-[#0e141b] dark:text-white placeholder:text-[#90a0b0] focus:ring-0 px-4 text-lg font-medium tracking-wide" placeholder="(11) 99999-9999" type="tel" />
                                    </div>
                                </div>
                            </label>
                        </div>
                        <div className="mb-6 w-full max-w-sm">
                            <button onClick={handleContinue} className="flex w-full cursor-pointer items-center justify-center rounded-xl h-12 px-5 bg-[#207fdf] hover:bg-blue-600 active:scale-[0.98] transition-all text-[#f8fafb] text-base font-bold leading-normal tracking-[0.015em] shadow-lg shadow-[#207fdf]/20">
                                <span className="mr-2">Continuar com WhatsApp</span>
                        ...
                        <div className="relative flex items-center justify-center py-2 mb-6 w-full max-w-sm">
                    ...
                    {/* Step 2 */}
                    <div className={`absolute inset-0 flex flex-col w-full h-full p-8 md:p-10 bg-white dark:bg-[#1a232e] justify-center items-center transition-all duration-500 ${step === 2 ? 'translate-x-0 opacity-100 pointer-events-auto' : 'translate-x-full opacity-0 pointer-events-none'}`}>
                        <div className="flex-1 flex flex-col justify-center w-full max-w-sm">
                            <button onClick={handleBack} className="self-start cursor-pointer text-slate-400 hover:text-[#207fdf] transition-colors mb-6 absolute top-10 left-10">
                            ...
                            <div className="text-center mb-8">
                                ...
                                <p className="text-slate-500 dark:text-slate-400 text-sm font-normal leading-relaxed">
                                    ...
                                    <span className="font-medium text-[#0e141b] dark:text-white">+55 (11) 99999-9999</span>
                                </p>
                            </div>
                            <div className="flex justify-center gap-3 mb-8">
                                {[1, 2, 3, 4].map((i) => (
                                    <input key={i} autoFocus={i === 1} className="w-14 h-16 rounded-xl border border-gray-300 dark:border-gray-600 bg-[#f6f7f8] dark:bg-[#111921] text-center text-2xl font-bold focus:ring-2 focus:ring-[#207fdf] focus:border-[#207fdf] text-[#0e141b] dark:text-white transition-all caret-[#207fdf]" maxLength={1} type="text" />
                                ))}
                            </div>
                            <div className="text-center mb-8">
                                <p className="text-sm text-slate-500 dark:text-slate-400">
                                    Não recebeu o código?
                                    <button className="font-bold text-[#207fdf] hover:underline ml-1">Reenviar</button>
                                </p>
                            </div>
                            <Link href="/checkout" className="flex w-full cursor-pointer items-center justify-center rounded-xl h-12 px-5 bg-[#207fdf] hover:bg-blue-600 active:scale-[0.98] transition-all text-[#f8fafb] text-base font-bold leading-normal tracking-[0.015em] shadow-lg shadow-[#207fdf]/20">
